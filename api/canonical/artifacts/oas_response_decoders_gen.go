...
func decodeGetArtifactResponse(resp *http.Response) (res GetArtifactRes, _ error) {
	...
	case 200:
		...
		case ct == "application/json":
			...
			var wrapper ArtifactRevisionHeaders
	...
	case 304:
		// Code 304.
		var wrapper GetArtifactNotModified
		h := uri.NewHeaderDecoder(resp.Header)
		// Parse "ETag" header.
		{
			cfg := uri.HeaderParameterDecodingConfig{
...
func decodeGetArtifactRevisionResponse(resp *http.Response) (res GetArtifactRevisionRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var wrapper GetArtifactRevisionOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-PowerContext-Request-ID" header.
			{
...
func decodeListArtifactsResponse(resp *http.Response) (res ListArtifactsRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var wrapper ArtifactPageHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-PowerContext-Request-ID" header.
			{
	...
	case 410:
		...
		case ct == "application/json":
			...
			var wrapper CursorExpiredHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-PowerContext-Request-ID" header.
			{
