...
func decodeDownloadSkillPackageResponse(resp *http.Response) (res DownloadSkillPackageRes, _ error) {
	...
	case 200:
		...
		case ct == "application/json":
			...
			var response SkillPackageDownload
			if err := func() error {
...
func decodeGetSkillPackageManifestResponse(resp *http.Response) (res GetSkillPackageManifestRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response SkillPackageManifest
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
...
func decodeProposeSkillPackageResponse(resp *http.Response) (res ProposeSkillPackageRes, _ error) {
	switch resp.StatusCode {
	case 201:
		// Code 201.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
...
func decodeRecordSkillUsageResponse(resp *http.Response) (res RecordSkillUsageRes, _ error) {
	switch resp.StatusCode {
	case 201:
		// Code 201.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
