...
func encodeDownloadSkillPackageResponse(response DownloadSkillPackageRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *SkillPackageDownload:
...
func encodeGetSkillPackageManifestResponse(response GetSkillPackageManifestRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *SkillPackageManifest:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
...
func encodeProposeSkillPackageResponse(response ProposeSkillPackageRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
...
func encodeRecordSkillUsageResponse(response RecordSkillUsageRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *CaptureContentSourceResponse:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(201)
