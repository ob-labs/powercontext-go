...
//go:generate go run ../tools/api-generate -spec canonical/upstream-powercontext.yaml -remote-skill-sidecar-manifest canonical/remote-skills-manifest.json -target ../api/canonical/remoteskills -package remoteskills -compatibility compatibility-surface.json -legacy-spec powercontext.yaml
