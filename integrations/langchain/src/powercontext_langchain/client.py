...
from .settings import PowerContextLangChainSettings, normalize_base_url
...
def resolve_config(
    ...
    *,
    ...
    return ResolvedConfig(
        base_url=normalize_base_url(resolved_scope.base_url or resolved_settings.base_url),
